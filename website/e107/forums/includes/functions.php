...
function set_config($config_name, $config_value, $is_dynamic = false)
{
	...
	$db->sql_query($sql);
    if($config_name == 'newest_user_colour'){  echo 'heres';
    print_r($config);}
...
function page_header($page_title = '', $display_online_list = true, $item_id = 0, $item = 'forum')
{
    ...
    //**************** Who's been online over 24 hours *****************
    include_once($phpbb_root_path. "includes/userwin24.php");
    //*******************************************************************
