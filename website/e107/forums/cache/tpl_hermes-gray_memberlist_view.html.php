...
<div id="pagecontent">
	...
	<tr>
		...
		<td class="row1">
			...
			<?php } $_custom_fields_count = (isset($this->_tpldata['custom_fields'])) ? sizeof($this->_tpldata['custom_fields']) : 0;if ($_custom_fields_count) {for ($_custom_fields_i = 0; $_custom_fields_i < $_custom_fields_count; ++$_custom_fields_i){$_custom_fields_val = &$this->_tpldata['custom_fields'][$_custom_fields_i]; if ($_custom_fields_val['S_PROFILE_XFIRE']) {  ?>

                <tr>
                    <td class="xfire" nowrap="nowrap" colspan="2">
                        <a href="http://profile.xfire.com/<?php echo (isset($this->_rootref['PROFILE_XFIRE'])) ? $this->_rootref['PROFILE_XFIRE'] : ''; ?>">
                            <img src="http://miniprofile.xfire.com/bg/<?php echo (isset($this->_rootref['PROFILE_XFIRE_STYLE_VALUE'])) ? $this->_rootref['PROFILE_XFIRE_STYLE_VALUE'] : ''; ?>/type/<?php echo (isset($this->_rootref['PROFILE_XFIRE_DISP_VALUE'])) ? $this->_rootref['PROFILE_XFIRE_DISP_VALUE'] : ''; ?>/<?php echo (isset($this->_rootref['PROFILE_XFIRE_VALUE'])) ? $this->_rootref['PROFILE_XFIRE_VALUE'] : ''; ?>.png" width="<?php echo (isset($this->_rootref['PROFILE_XW'])) ? $this->_rootref['PROFILE_XW'] : ''; ?>" height="<?php echo (isset($this->_rootref['PROFILE_XH'])) ? $this->_rootref['PROFILE_XH'] : ''; ?>" /></a>
                        <br /><div style="font-size: 1em;"><a href="xfire:add_friend?user=<?php echo (isset($this->_rootref['PROFILE_XFIRE_VALUE'])) ? $this->_rootref['PROFILE_XFIRE_VALUE'] : ''; ?>"><?php echo ((isset($this->_rootref['L_ADD_XFIRE_USER'])) ? $this->_rootref['L_ADD_XFIRE_USER'] : ((isset($user->lang['ADD_XFIRE_USER'])) ? $user->lang['ADD_XFIRE_USER'] : '{ ADD_XFIRE_USER }')); ?></a> | <a href="http://www.xfire.com/download/"><?php echo ((isset($this->_rootref['L_DOWNLOAD_XFIRE'])) ? $this->_rootref['L_DOWNLOAD_XFIRE'] : ((isset($user->lang['DOWNLOAD_XFIRE'])) ? $user->lang['DOWNLOAD_XFIRE'] : '{ DOWNLOAD_XFIRE }')); ?></a></div>
                    </td>
                </tr>
                <?php } else if ($_custom_fields_val['S_PROFILE_STEAM_ID']) {  ?>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <a href="http://cdn.steampowered.com/download/SteamInstall.msi" target="_blank"><?php echo ((isset($this->_rootref['L_DOWNLOAD_STEAM'])) ? $this->_rootref['L_DOWNLOAD_STEAM'] : ((isset($user->lang['DOWNLOAD_STEAM'])) ? $user->lang['DOWNLOAD_STEAM'] : '{ DOWNLOAD_STEAM }')); ?></a> <br /></div>
                    </td>
                </tr>
               <?php } else { ?>
