...
define("LAN_SIGNUP_13", "You can now log in from the Login box, or from <a href='".e_BASE."index.php'>here</a>.");
...
define ('LAN_SIGNUP_107', 'Day: ');
define ('LAN_SIGNUP_108', 'Month: ');
define ('LAN_SIGNUP_109', 'Year: ');
