...
if(!isset($SITEDOWN_TABLE))
{
	...
	<body>
		<div style='text-align:center;font-size: 14px; color: white; font-family: Tahoma, Verdana, Arial, Helvetica; text-decoration: none'>
		<div style='text-align:left'><img src=\"".THEME_ABS."./images/banner/banner".$banner.".jpg\" alt=\"pride-gaming\" width=\"45%\" height=\"175\" /></div>
		<hr />
		<br />
