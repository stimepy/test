...
if("link" == $parm)
{
	return e107UserUrl($pm_info['pm_from'], pm_info['user_name']);
}
else
{
...
if(is_numeric($pm_info['pm_to']))
{
	if("link" == $parm)
	{
		return e107UserUrl($pm_info['pm_to'],$pm_info['user_name']);
	}
	else
	{
		return $pm_info['user_name'];
...
if('link' == $parm)
{
	return e107UserUrl($pmBlocked['pm_block_from'],$pmBlocked['user_name']);
}
else
{
