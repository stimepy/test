...
function ClientSideShortPassword(){
	return (IsLongEnough(ClientSideShortPassword.arguments[0], PasswordLength));
}

function ClientSideEmptyPassword(){
	return (IsLongEnough(ClientSideEmptyPassword.arguments[0], "0"));
}
...
function EvalPwdStrength(oF,sP){
	...
	{
	if(!ClientSideShortPassword(sP,gSimilarityMap,gDictionary)){
		DispPwdStrength(1);
	}
	else
	{
