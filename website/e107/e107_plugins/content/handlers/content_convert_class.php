...
class content_convert{
		...
		function upgrade_1_2(){
			...
			if($field1 != "content_score" && $field2 != "content_meta" && $field3 != "content_layout"){
                $sql->db_QueryFreeForm("ALTER TABLE ".MPREFIX."pcontent ADD content_score TINYINT ( 3 ) UNSIGNED NOT NULL DEFAULT '0';");
                $sql->db_QueryFreeForm("ALTER TABLE ".MPREFIX."pcontent ADD content_meta TEXT NOT NULL;");
                $sql->db_QueryFreeForm("ALTER TABLE ".MPREFIX."pcontent ADD content_layout VARCHAR ( 255 ) NOT NULL DEFAULT '';");
