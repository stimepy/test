...
if(e_QUERY)
{
	...
	if($sql->db_Select_gen($query))
	{
		...
		<div class='smalltext'>". POLLAN_35 . e107UserUrl($user_id, $user_name) .".<br /> ".POLLAN_37." ".$start_datestamp." ".POLLAN_38." ".$end_datestamp.".<br />".POLLAN_26.": {$voteTotal}</div>
		<br />
...
foreach($oldpollArray as $oldpoll)
{
	...
	<td class='forumheader3' style='width: 15%;'>". e107UserUrl($poll_admin_id, $user_name) ."</td>
