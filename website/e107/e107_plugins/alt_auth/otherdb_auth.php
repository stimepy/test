...
class otherdb_mysql_class
{
	...
	function login($uname, $pword, &$newvals)
	{
        ...
        $res = new db();
		if($res->db_Connect($this->conf['otherdb_server'], $this->conf['otherdb_username'], $this->conf['otherdb_password'], $this->conf['otherdb_database'])){
            return AUTH_NOCONNECT;
		}
