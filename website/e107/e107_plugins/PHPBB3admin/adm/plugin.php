...
$eplug_description = "PHPBB 3 administration";
...
$eplug_menu_name = "PHPBB 3";
$eplug_conffile = "ucp.php?mode=login";
$eplug_caption = "PHPBB Admin";


$eplug_link = TRUE;
$eplug_link_name = "PHPBB 3";
$eplug_link_url = "PHPBB3/";
...
"CREATE TABLE TABLE IF NOT EXISTS ".MPREFIX."_MA_mapp(
...
"CREATE TABLE IF NOT EXISTS ".MPREFIX."_MA_mappresp (
...
"CREATE TABLE IF NOT EXISTS ".MPREFIX."_MA_mapcfg (
