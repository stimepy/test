...
function autologin_e107()
{
	...
	if (!empty($e107_auth_user) && !empty($e107_auth_pw))
	{
		...
		$phpbb_user=user_add(user_row_e107($e107_auth_user, $e107_auth_pw, $e107_email, $dispname));
		...
		$e107_update="Update e107_user set phpbb_id=".$phpbb_user;
		$result = $db->sql_query($e107_update);
...
function get_field_e107() {
	...
	$bbsql = 'SHOW COLUMNS FROM ' . USERS_TABLE . " LIKE 'loginname'";
	$result = $db->sql_query($bbsql);
