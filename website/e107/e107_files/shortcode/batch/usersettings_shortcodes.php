...
{
		return "<input class='tbox' name='uploadfile' type='file' size='47' />";
}
SC_END

SC_BEGIN AVATAR_REMOTE
global $curVal;
return "<input class='tbox' type='text' name='remotelink' size='60' value='".$curVal['user_image']."' maxlength='100' />";
SC_END
...
global $ef, $USEREXTENDED_FIELD;

return $ef->create_extendedfields($USEREXTENDED_FIELD,'profile', USERID);
SC_END
