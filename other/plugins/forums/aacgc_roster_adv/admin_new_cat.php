...
If ($newok == "1"){
$sql->db_Insert("aacgc_roster_adv_cat", "NULL, '".$newcatname."'") or die(mysql_error());
...
$text .= "
        ...
        <input class='tbox' type='text' name='cat_name' size='50'>
        </td>
        </tr>";
...
<br>
	      ...
	      $ns -> tablerender("AACGC Advanced Roster (Create Category)", $text);
