...
$themename = "Pride";
$themeversion = "1.0";
$themeauthor = "Angelofdoom";
$themedate = "01/01/2012";
$themeinfo = "";
...
$HEADER="<table width=100%>
        ...
        <td colspan=\"2\">
           <center>
                <div id=\"head-container\">
                    <img src=\"".THEME_ABS."./images/coming-4-u_1.jpg\" alt=\"pride-gaming\" width=\"24%\" height=\"175\" />
                    <img src=\"".THEME_ABS."./images/banner/banner".$banner.".jpg\" alt=\"pride-gaming\" width=\"50%\" height=\"175\" />
                    <img src=\"".THEME_ABS."./images/snip_doom.jpg\" alt=\"pride-gaming\" width=\"24%\" height=\"175\" />
                    <br />
                </div>
           </center>
        </td>
    ...
    <tr>
        <td class=\"menu_nav\" width=15%>
            <table class=\"top_left_menu_container\" width=\"100%\">
                 <tr>
                    <td class=\"menu_nav\">
...
$NEWSSTYLE = "<div class='tablerender'><div class='main_caption'>{STICKY_ICON}{NEWSTITLE}</div>{NEWSBODY}{EXTENDED}</div>
...
function tablestyle($caption, $text, $mode){
	...
	else if ($style == 'bottom_left_menu' || $style == 'right_menu') 
	{
        ...
        echo "<div class='tablerender'><div class='menu_caption2'>".$caption."</div>".$text."</div>";
    }
	else 
	{ 
